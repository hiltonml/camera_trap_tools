...
name of the k-NN database to use.
...
class TrailCamOCR:
    ...
    def __init__(self):
        ...
        #   datafile        path to file containing k-NN database for this image size
        ...
        self.codebooks = { 
            ...
            "meidase_SL122_Pro_2560x1440" : {
                "function": self.digit_meidase,
                "datafile": "digits_meidase_2560x1440.csv",
                "xwidth" : 46,
                "ycoords" : (1334,1399),
    ...
    def digit_meidase(self, codebook, field, index, img):
        """
    ...
    def generateTrainingData(self, folder, frac, outputFilename, maxFiles=10_000, 
        ...
        with open(outputFilename, "w") as fp:
            ...
            for file in files:
                ...
                if img is None:
                    raise Exception("generateTrainingData: Unable to read image " + file)   

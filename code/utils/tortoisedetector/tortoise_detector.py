...
class TortoiseDetector(TrailCamObjectDetector):
    def __init__(self, app_config):
        ...
        # read the Tortoise Detector configuration file
        configFile = self.getConfigFilename()
        self.od_config = ObjectDetectorConfig(configFile)

        # instantiate the two neural nets used by this detector
        self.od1 = OD_EfficientDet0(self.od_config)
        self.od2 = OD_MobileNet(self.od_config)

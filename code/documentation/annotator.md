...
- The annotation editing controls let you add or delete activities from the timeline.  The appearance of the editing controls will change depending on the annotation mode selected in the configuration file.  Annotation modes will be described below.

### Counting Mode
Counting mode was created to simplify marking video segments containing either a single animal or multiple animals.  You cannot specify which animal(s) are present.
